...
from metagenome2vec.assessing import kmer_embeddings, benchmark_classif, genome_embeddings_projection, read2genome_scores
...
if __name__ == "__main__":
    ...
    if args.command == "read2genome_scores":
        ...
        df_taxonomy_ref = pd.read_csv(args.path_metadata).astype(str)
        
        n_instance = args.n_instance
        bowtie_index = args.bowtie_index  # TODO check this argument
        read2genome_scores.compute_scores(spark, df_train, df_valid, read2genome, df_taxonomy_ref,
                                          args.tax_level, tax_taken, args.n_sample_load, args.n_cpus)
