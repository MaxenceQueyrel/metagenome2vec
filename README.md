...
### Data download
The script $METAGENOME2VEC_PATH/script/data_processing/dowload/download_metagenomic_data_from_tsv_file.sh loads metagenomic data from a tsv file extracted on the NCBI website.
