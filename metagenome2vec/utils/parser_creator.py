...
class ParserCreator(object):
    def __init__(self):
        ...
        self.D_parser["-pkc"] = {
            "name": "--path_kmer_count",
            "arg": {
                "metavar": "path_kmer_count",
                "type": str,
                "default": None,
        ...
        self.D_parser["-pas"] = {
            "name": "--parameter_structu",
            "arg": {
                "metavar": "parameter_structu",
                "type": str,
                "required": True,
        ...
        self.D_parser["-pal"] = {
            "name": "--parameter_learning",
            "arg": {
                "metavar": "parameter_learning",
                "type": str,
                "required": True,
        ...
        self.D_parser["-NSIM"] = {
            "name": "--n_show_similarity",
            "arg": {
                "metavar": "n_show_similarity",
                "type": int,
                "default": 3,
        ...
        self.D_parser["-kea"] = {
            "name": "--kmer_embeddings_algorithm",
            "arg": {
                "metavar": "kmer_embeddings_algorithm",
                "type": str,
                "default": "fasttext",
        ...
        self.D_parser["-vfn"] = {
            "name": "--vocabulary_file_name",
            "arg": {
                "metavar": "vocabulary_file_name",
                "type": str,
                "default": "vocab.txt",
        ...
        self.D_parser["-cfn"] = {
            "name": "--cooccurrence_file_name",
            "arg": {
                "metavar": "cooccurrence_file_name",
                "type": str,
        ...
        self.D_parser["-nsc"] = {
            "name": "--n_sample_by_class",
            "arg": {
                "metavar": "n_sample_by_class",
                "type": int,
                "default": 10000,
        ...
        self.D_parser["-ns"] = {
            "name": "--nb_sequences_by_metagenome",
            "arg": {
                "metavar": "nb_sequences_by_metagenome",
                "type": int,
                "required": True,
        ...
        self.D_parser["-MIL"] = {
            "name": "--multi_instance_layer",
            "arg": {
                "metavar": "multi_instance_layer",
                "type": str,
        ...
        self.D_parser["-rv"] = {
            ...
            "arg": {
                ...
                "type": str,
                "required": True,
                "choices": ["fastDNA", "fastText", "basic", "transformer"],
        ...
        self.D_parser["-nri"] = {
            "name": "--n_reads_instance",
            "arg": {
                "metavar": "n_reads_instance",
                "type": int,
                "default": 1e5,
        ...
        self.D_parser["-prt"] = {
            "name": "--path_read_transformed",
            "arg": {
                "metavar": "path_read_transformed",
                "type": str,
                "required": True,
        ...
        self.D_parser["-pmwc"] = {
            "name": "--path_metagenome_word_count",
            "arg": {
                "metavar": "path_metagenome_word_count",
                "type": str,
                "default": None,
        ...
        self.D_parser["-pgd"] = {
            "name": "--path_genome_dist",
            "arg": {
                "metavar": "path_genome_dist",
                "type": str,
                "default": None,
        ...
        self.D_parser["-mla"] = {
            ...
            "arg": {
                "metavar": "machine_learning_algorithm",
                "type": str,
                "default": "gmb",
        ...
        self.D_parser["-prg"] = {
            "name": "--path_read2genome",
            "arg": {
                "metavar": "path_read2genome",
                "type": str,
                "default": None,
                "help": "Complete path to read2vec model",
            },
        ...
        self.D_parser["-pmca"] = {
            "name": "--path_metagenome_cut_analyse",
            "arg": {
                "metavar": "path_metagenome_cut_analyse",
                "type": str,
                "default": None,
        ...
        self.D_parser["-pt"] = {
            "name": "--path_tmp_folder",
            "arg": {
                "metavar": "path_tmp_folder",
                "type": str,
                "default": None,
        ...
        self.D_parser["-DS"] = {
            "name": "--deepsets_struct",
            "arg": {
                "metavar": "deepsets_struct",
                "type": str,
                "default": "200,100,1,1",
        ...
        self.D_parser["-TU"] = {
            "name": "--tuning",
            "arg": {"action": "store_true", "help": "Specify to tune or not the model"},
        }
        self.D_parser["-FT"] = {
            "name": "--fine_tuning",
            "arg": {
        ...
        self.D_parser["-pfsr"] = {
            "name": "--path_folder_save_read2genome",
            "arg": {
                "metavar": "path_folder_save_read2genome",
                "type": str,
                "default": None,
        ...
        self.D_parser["-pjma"] = {
            "name": "--path_json_modif_abundance",
            "arg": {
                "metavar": "path_json_modif_abundance",
                "type": str,
                "required": False,
        ...
        self.D_parser["-pap"] = {
            "name": "--path_abundance_profile",
            "arg": {
                "metavar": "path_abundance_profile",
                "type": str,
                "required": True,
        ...
        self.D_parser["-ftd"] = {
            "name": "--list_file_to_del",
            "arg": {
                "metavar": "list_file_to_del",
                "type": str,
                "default": None,
                "required": False,
    ...
    def parser_bok_split(self, parser=None):
        ...
        for k in ["-pd", "-ps"]:
            if k == "-pd":
                self.D_parser[k]["arg"][
                    "help"
                ] = "The path od he tsv file containing information to download the data."
            parser.add_argument(k, self.D_parser[k]["name"], **self.D_parser[k]["arg"])
        return parser.parse_args()

    def parser_bok_split(self, parser=None):
        parser = argparse.ArgumentParser(
            description="Arguments for bag of kmer split split"
        )
        for k in [
            "-k",
            "-s",
    ...
    def parser_bok_merge(self):
        ...
        for k in ["-lf", "-pg", "-pd", "-np", "-mo", "-bu", "-o", "-ng"]:
            if k == "-ct":
                self.D_parser[k]["arg"][
                    "help"
                ] = "0 : do not save temporary matrix, 1 save all temporary matrix, 2 save one temporary matrix in case of bug"
            parser.add_argument(k, self.D_parser[k]["name"], **self.D_parser[k]["arg"])
        return parser.parse_args()

    def parser_structuring_sequence_learning_merge(self):
        parser = argparse.ArgumentParser(
            description="Arguments for the structuring of the learning"
        )
        for k in [
            "-k",
            "-w",
    ...
    def parser_word2vec(self):
        parser = argparse.ArgumentParser(
            description="Arguments for the kmer2vec algorithm"
        )
        for k in [
            "-dn",
            "-k",
    ...
    def parser_word2vec_genome(self):
        ...
        for k in [
            ...
            if k == "-pd":
                self.D_parser[k]["arg"][
                    "help"
                ] = "path to the text file that is the corpus to learn."
            if k == "-pt":
    ...
    def parser_clean_raw_data(self):
        parser = argparse.ArgumentParser(
            description="Arguments for the generation of sample metagenome"
        )
        for k in [
            "-pd",
            "-nsl",
            ...
            if k == "-nsl":
                ...
                self.D_parser[k]["arg"][
                    "help"
                ] = "Maximum number of reads loaded for one sample "
            parser.add_argument(k, self.D_parser[k]["name"], **self.D_parser[k]["arg"])
        return parser.parse_args()
    ...
    def parser_fasttext(self):
        parser = argparse.ArgumentParser(
            description="Arguments for the fasttext algorithm"
        )
        for k in [
            "-E",
            "-S",
    ...
    def parser_analyse_embeddings(self):
        parser = argparse.ArgumentParser(
            description="Arguments for the embeddings analysis"
        )
        for k in ["-pd", "-pkv", "-ct", "-nc", "-ni", "-o"]:
            if k == "-ct":
                self.D_parser[k]["arg"][
                    "help"
                ] = "Computation type : Comma separated string with each option wanted. 0 t-sne projection, 1 edit vs cosine similarity, 2 needlman-wunsch vs cosine similarity, 3 compute all analysis"
                self.D_parser[k]["arg"]["type"] = str
                del self.D_parser[k]["arg"]["choices"]
            if k == "-ni":
                self.D_parser[k]["arg"][
                    "help"
                ] = "Number of k-mers to compute in the analysis."
            ...
            if k == "-pd":
                ...
                self.D_parser[k]["arg"][
                    "help"
                ] = "Path to the data used for the embeddings training"
            parser.add_argument(k, self.D_parser[k]["name"], **self.D_parser[k]["arg"])
        return parser.parse_args()

    def parser_analyse_matrix_distance(self):
        parser = argparse.ArgumentParser(
            description="Arguments for the distance matrix analysis"
        )
    ...
    def parser_deepsets(self):
        ...
        for k in [
            ...
            if k == "-pm":
                self.D_parser[k]["arg"][
                    "help"
                ] = "Path to the folder to save tunning files and model"
                self.D_parser[k]["arg"]["required"] = True
            if k == "-ps":
                self.D_parser[k]["arg"][
                    "help"
                ] = "Complete path to the file where is saved the deepsets scores"
                self.D_parser[k]["arg"]["required"] = True
            if k == "-pd":
    ...
    def parser_vae(self):
        ...
        for k in [
            ...
            if k == "-ct":
                self.D_parser[k]["arg"][
                    "help"
                ] = "If vae uses variational auto encoder, else if ae uses auto encoder"
    ...
    def parser_benchmark(self):
        ...
        for k in [
            ...
            if k == "-pd":
                self.D_parser[k]["arg"][
                    "help"
                ] = "Complete path to the matrix to feed into the benchmark"
                self.D_parser[k]["arg"]["required"] = True
            if k == "-I":
                self.D_parser[k]["arg"]["required"] = True
            if k == "-ps":
                self.D_parser[k]["arg"][
                    "help"
                ] = "Complete path of the file where the results are saved"
                self.D_parser[k]["arg"]["required"] = True
            if k == "-pm":
                self.D_parser[k]["arg"][
                    "help"
                ] = "Complete path to the parameters of the vae model saved in json"
                self.D_parser[k]["arg"]["default"] = None
                self.D_parser[k]["arg"]["required"] = False
            if k == "-ct":
                self.D_parser[k]["arg"][
                    "help"
                ] = "Transformation for compositional data. Could be alr, clr or ilr. If defined, data are reformed as compositional data."
                self.D_parser[k]["arg"]["default"] = None
                self.D_parser[k]["arg"]["required"] = False
                self.D_parser[k]["arg"]["type"] = str
                self.D_parser[k]["arg"]["choices"] = [
                    None,
                    "alr",
                    "clr",
                    "ilr",
            ...
            if k == "-fn":
                self.D_parser[k]["arg"][
                    "help"
                ] = "Number of models trained in random grid search."
                self.D_parser[k]["arg"]["required"] = False
    ...
    def parser_cluster_map(self):
        ...
        for k in ["-pd", "-pmd"]:
            if k == "-pd":
                self.D_parser[k]["arg"][
                    "help"
                ] = "Complete path to the matrix for the cluster map"
                self.D_parser[k]["arg"]["required"] = True
            if k == "-pmd":
                self.D_parser[k]["arg"][
                    "help"
                ] = "Absolute path to a csv file containing 2 columns : 'id.fasta' (the metagenome's id) and 'group' that is the class of a metagenome"
            parser.add_argument(k, self.D_parser[k]["name"], **self.D_parser[k]["arg"])
        return parser.parse_args()

    def parser_generate_local_kmerized_metagenome(self):
        parser = argparse.ArgumentParser(
            description="Arguments for ELMo files generation"
        )
        for k in [
            "-pd",
            "-pl",
    ...
    def parser_bok(self):
        parser = argparse.ArgumentParser(
            description="Arguments for structuring metagenomes to BoK representation"
        )
        for k in ["-pd", "-k", "-o", "-pg", "-lf", "-pmd"]:
            ...
            if k == "-pd":
                ...
                self.D_parser[k]["arg"][
                    "help"
                ] = "Path were are saved the BoK files for each metagenomes. It is also where is saved the BoK final matrix with metagenome info concatenated"
        return parser.parse_args()

    def parser_metagenome2vec(self):
        parser = argparse.ArgumentParser(
            description="Arguments for transformation metagenomes' reads to embeddings"
        )
        for k in [
            "-ps",
            "-k",
            ...
            if k == "-f":
                ...
                self.D_parser[k]["arg"][
                    "help"
                ] = "The suffix name of the matrix file saved. To identify all matrix"
            if k == "-m":
                self.D_parser[k]["arg"]["default"] = "mean"
                self.D_parser[k]["arg"][
                    "help"
                ] = "Computation method : mean or sum are available"
            if k == "-ct":
                self.D_parser[k]["arg"][
                    "help"
                ] = "Comma separated string with value: 0 tabular, 1 MIL, 2 for cut metagenome analysis"
                self.D_parser[k]["arg"]["type"] = str
                del self.D_parser[k]["arg"]["choices"]
            if k == "-B":
            ...
            if k == "-m":
                ...
                self.D_parser[k]["arg"][
                    "help"
                ] = "The path where is saved the read2genome model"
            if k == "-T":
                self.D_parser[k]["arg"]["default"] = 0.0
                self.D_parser[k]["arg"]["type"] = float
                self.D_parser[k]["arg"][
                    "help"
                ] = "Value of the threshold for the read2genome"
            parser.add_argument(k, self.D_parser[k]["name"], **self.D_parser[k]["arg"])
        return parser.parse_args()
    ...
    def parser_seq2seq(self):
        ...
        for k in [
            ...
            if k == "-pd":
                ...
                self.D_parser[k]["arg"][
                    "help"
                ] = "Comma separated path first for training second for validation"
            if k == "-f":
                self.D_parser[k]["arg"]["required"] = True
                self.D_parser[k]["arg"][
                    "help"
                ] = "The file name to save the pytorch model learnt"
            if k == "-ca":
                self.D_parser[k]["arg"]["required"] = False
            if k == "-S":
                self.D_parser[k]["arg"]["default"] = 10
    ...
    def parser_train_h2o_model(self):
        ...
        for k in [
            ...
            if k == "-f":
                self.D_parser[k]["arg"][
                    "help"
                ] = "Name of the read2genome model when saved"
                self.D_parser[k]["arg"]["required"] = True
            if k == "-k":
                self.D_parser[k]["arg"]["required"] = False
            if k == "-pd":
                ...
                self.D_parser[k]["arg"][
                    "help"
                ] = "Two complete path separated by a coma respectively for train and valid data set"
                self.D_parser[k]["arg"]["default"] = 10
            if k == "-np":
                self.D_parser[k]["arg"]["default"] = None
            if k == "-nsl":
            ...
            if k == "-ps":
                ...
                self.D_parser[k]["arg"][
                    "help"
                ] = "Path were is save the parquet file after reads transformation of simulation data"
            parser.add_argument(k, self.D_parser[k]["name"], **self.D_parser[k]["arg"])
        return parser.parse_args()

    def parser_analyse_read2genome(self):
        parser = argparse.ArgumentParser(
            description="Arguments for analyse read2genome"
        )
        for k in [
            "-pm",
            "-pd",
            ...
            if k == "-pm":
                self.D_parser[k]["arg"][
                    "help"
                ] = "Path where is saved the read2genome model"
            if k == "-nsl":
                self.D_parser[k]["arg"]["default"] = -1
            if k == "-ni":
                ...
                self.D_parser[k]["arg"][
                    "help"
                ] = "Number of reads computed for bowtie score"
            parser.add_argument(k, self.D_parser[k]["name"], **self.D_parser[k]["arg"])
        return parser.parse_args()

    def parser_create_simulated_read2genome_dataset(self):
        parser = argparse.ArgumentParser(
            description="Arguments for create simulation dataset"
        )
        for k in ["-pd", "-nsl", "-o", "-vs", "-pmd"]:
            ...
            if k == "-nsl":
                self.D_parser[k]["arg"][
                    "help"
                ] = "Number of reads taken in the simulation dataset"
                self.D_parser[k]["arg"]["default"] = -1
            parser.add_argument(k, self.D_parser[k]["name"], **self.D_parser[k]["arg"])
        return parser.parse_args()
    ...
    def parser_create_simulated_metagenome2vec_dataset(self):
        ...
        for k in ["-pd", "-ps", "-o", "-tm"]:
            if k == "-pd":
                self.D_parser[k]["arg"][
                    "help"
                ] = "Comma separated path to the folders containing the simulation data. One folder corresponds to a class of samples."
            parser.add_argument(k, self.D_parser[k]["name"], **self.D_parser[k]["arg"])
        return parser.parse_args()
    ...
    def parser_fastdna(self):
        ...
        for k in [
            ...
            if k == "-f":
                self.D_parser[k]["arg"][
                    "help"
                ] = "Name of the model trained (used for saving files)"
                self.D_parser[k]["arg"]["required"] = True
            if k == "-pd":
                self.D_parser[k]["arg"][
                    "help"
                ] = "comma separated path, first is reads fasta file, second is corresponding labels"
                self.D_parser[k]["arg"]["required"] = True
            if k == "-pm":
            ...
            if k == "-pkv":
                self.D_parser[k]["arg"][
                    "help"
                ] = "Complete path to save final embeddings"
                self.D_parser[k]["arg"]["required"] = False
            parser.add_argument(k, self.D_parser[k]["name"], **self.D_parser[k]["arg"])
        return parser.parse_args()
    ...
    def parser_genome_kmerization(self):
        parser = argparse.ArgumentParser(
            description="Arguments for genomes kmerization"
        )
        for k in ["-k", "-s", "-pd", "-ps"]:
            if k == "-pd":
    ...
    def parser_genome_projection(self):
        ...
        for k in [
            ...
            if k == "-pd":
                self.D_parser[k]["arg"][
                    "help"
                ] = "Path to the genome data folder containing the fasta files"
                self.D_parser[k]["arg"]["required"] = True
            if k == "-pmd":
                self.D_parser[k]["arg"][
                    "help"
                ] = "Absolute path to the metadata file composed by 4 columns tax_id, genus, family, fasta"
                self.D_parser[k]["arg"]["required"] = True
            if k == "-ps":
                self.D_parser[k]["arg"]["help"] = "Path to the saved kmerized genome"
                self.D_parser[k]["arg"]["required"] = True
    ...
    def parser_kmer_count(self):
        ...
        for k in ["-pd", "-ps", "-mo"]:
            ...
            if k == "-mo":
                self.D_parser[k]["arg"][
                    "help"
                ] = "'word_count_matrix' if the file given is the output from word_count_split and word_count_merge or 'kmerized_genome_dataset' if the file is the output of kmerization"
                self.D_parser[k]["arg"]["default"] = "word_count_matrix"
                self.D_parser[k]["arg"]["choices"] = [
                    "word_count_matrix",
                    "kmerized_genome_dataset",
                ]
            parser.add_argument(k, self.D_parser[k]["name"], **self.D_parser[k]["arg"])
        return parser.parse_args()
    ...
    def parser_create_df_fasta_metadata(self):
        parser = argparse.ArgumentParser(
            description="Arguments to create dataframe fasta metadata"
        )
        for k in ["-pd", "-ps", "-pjma", "-pmd", "-sa"]:
            ...
            if k == "-pmd":
                ...
                self.D_parser[k]["arg"][
                    "help"
                ] = "If given it corresponds to a path of an already existing metadata file, this avoid computation time when generating it"
            if k == "-pd":
                self.D_parser[k]["arg"][
                    "help"
    ...
    def parser_create_camisi_config_file(self):
        parser = argparse.ArgumentParser(
            description="Arguments for the creation of camisim config file"
        )
        for k in ["-ps", "-nc", "-nsc", "-ct", "-pt", "-go", "-pap"]:
            if k == "-ct":
                ...
                self.D_parser[k]["arg"][
                    "help"
                ] = "'illumina', 'nanosim' or 'both' simulator"
            if k == "-pd":
                self.D_parser[k]["arg"][
                    "help"
                ] = "ath of the create_df_fasta_metadata output"
            parser.add_argument(k, self.D_parser[k]["name"], **self.D_parser[k]["arg"])
        return parser.parse_args()
