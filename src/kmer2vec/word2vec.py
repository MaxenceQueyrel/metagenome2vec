...
if __name__ == "__main__":
    ...
    param_word2vec = "embSize_%s_nStep_%s_learRate_%s/" % (embedding_size, n_steps, learning_rate)
    ...
    path_save = os.path.join(path_analysis, "kmer2vec", "genome", catalog, "word2vec", parameter_structu, param_word2vec)
